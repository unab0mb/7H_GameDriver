...
#define trace(x, ...) debug_printf("TRACE", trace_all, text_colors[TEXTCOLOR_GREEN], (x), __VA_ARGS__)
#define glitch(x, ...) debug_printf("GLITCH", glitch_popup, text_colors[TEXTCOLOR_YELLOW], (x), __VA_ARGS__)
